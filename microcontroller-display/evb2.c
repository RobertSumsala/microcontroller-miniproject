...
//********************************************************************
// Kniznica funkci� pre modul LCD displeja s radi�om HD44780
//
// prepojenie pinov procesora s pinmi modulu LCD displeja:
// P1.0 => LCD_RS - vstup sign�lu Register Select, pin 4 modulu LCD
// P1.1 => LCD_EN - vstup sign�lu ENable, pin 6 modulu LCD
// P1.4 => DB4 - d�tov� vodi� 4, Data Bus 4, pin 11 modulu LCD
// P1.5 => DB5 - d�tov� vodi� 5, Data Bus 5, pin 12 modulu LCD
// P1.6 => DB6 - d�tov� vodi� 6, Data Bus 6, pin 13 modulu LCD
// P1.7 => DB7 - d�tov� vodi� 7, Data Bus 7, pin 14 modulu LCD
//********************************************************************
...
{
    LCD_RS_L;
    lcd_write(0x40+pos); // zmenene z 80 na 40 aby sme sa dostali na CGRAM
}
